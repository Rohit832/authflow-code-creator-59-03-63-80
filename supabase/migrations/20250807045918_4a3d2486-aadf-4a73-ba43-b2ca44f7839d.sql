-- Drop the individuals table and all dependencies

-- First drop any triggers that might reference the individuals table
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_individual_user();
